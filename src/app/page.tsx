...
const ServiceCard = ({ icon: Icon, title, desc, link, badge }: any) => (
  <Link href={link} className="group bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all active:scale-95">
    <div className="flex items-start justify-between mb-4">
      ...
      <span className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-xs font-bold">{badge}</span>
    </div>
...
const NewsCard = ({ title, date, category, preview }: any) => (
  <div className="bg-white rounded-2xl p-5 shadow-md hover:shadow-xl transition-all active:scale-95">
    <div className="flex items-center gap-3 mb-3">
      <span className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-xs font-semibold">{category}</span>
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-12 text-center text-white">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4 drop-shadow-lg">Dnyanasadhana College</h1>
          <p className="text-xl md:text-2xl font-medium text-blue-200 mb-6">Alumni Portal</p>
          <p className="text-base md:text-lg mb-8 max-w-2xl mx-auto opacity-90">Empowering minds, shaping futures since 1964. Join our distinguished community of alumni worldwide.</p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Alumni Services</h2>
